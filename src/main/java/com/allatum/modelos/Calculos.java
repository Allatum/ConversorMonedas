...
public class Calculos {
    ...
    public void almacenarValores(String monedaBase, String monedaObjetivo, double cantidad) {
    ...
    public void almacenarValoresPersonalizados(Scanner lectura){
        ...
        while (true) {
            System.out.println("Ingrese la moneda base (3 letras, ej: USD):");
            this.monedaBase = lectura.nextLine().toUpperCase().trim();
            if (monedaBase.length() == 3 && monedaBase.matches("[A-Z]+")) {
                break;
            }
        ...
        do {
            ...
            String valorInput = lectura.nextLine();
            try {
                this.cantidad = Double.parseDouble(valorInput);
                if (this.cantidad < 0) {
...
//                entradaValida = true;
//            } catch (NumberFormatException e) {
//                System.out.println("Error: Por favor, ingrese un número válido (ej: 100 o 50.5).");
//            }
//        } while (!entradaValida);
//    }

    public String obtenerMensajeRespuesta() {
        String resultado = conversion.buscaConversion(getMonedaBase(), getMonedaObjetivo(), getCantidad());
        String mensaje = String.format("%s %.2f equivale a: %s %s",
                getMonedaBase().toUpperCase(),
                getCantidad(),
